...
<div class="space-y-8">
    ...
    <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            {{-- Browse Vendors --}}
            <a href="{{ route('vendors.index') ?? '#' }}" class="group flex items-center gap-4 bg-[#1a1a2e]/80 border border-gray-800 rounded-xl p-5 hover:border-green-500/30 hover:shadow-lg hover:shadow-green-500/5 transition-all duration-300 hover:scale-105">
    ...
    <div>
        ...
        @else
            ...
            <div class="bg-[#1a1a2e]/80 border border-gray-800 border-dashed rounded-xl p-10 text-center">
                ...
                <a href="{{ route('vendors.index') ?? '#' }}" class="text-orange-400 hover:text-orange-300 text-sm font-medium transition-colors">Jelajahi Pedagang →</a>
            </div>
        @endif
    </div>
